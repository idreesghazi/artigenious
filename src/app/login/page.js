      ...
      <div className='text-center'>
        ...
        <div class="flex flex-col space-y-5 pt-8">
          <div class="relative">
            ...
            <input type="email" placeholder="Your Email" class="pl-12 pr-4 py-5 bg-[#F2F2F2] border-0 rounded-2xl w-120 focus:border-black font-poppins" />
          </div>
          <div class="relative">
            <Image src={passwordIcon} class="absolute left-0 top-1/2 transform -translate-y-1/2 ml-3" alt="Password Icon" />
            <input type="password" placeholder="Password" class="pl-12 pr-4 py-5 bg-[#F2F2F2] border-0 rounded-2xl w-120 focus:border-black font-poppins" />
          </div>
        </div>  
        ...
        <button className='p-5 w-120 bg-[#1C1C1C] text-white font-poppins rounded-2xl hover:scale-105 shadow-sm hover:shadow-md transition duration-300 ease-in-out text-lg font-semibold'>Next</button>
