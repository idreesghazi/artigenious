            ...
            <div className="flex justify-center items-center">
                <div className="w-full mx-auto px-8 py-4 flex justify-center space-x-28">
                            ...
                            <div className="mb-4">
                                ...
                                <form>
                                    <div className="space-x-6 mb-4">
                                        <input type="text" name='cardNumber' value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} placeholder="0000 0000 0000 0000" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />
                                        <input type="number" name='mm' value={mm} onChange={(e) => setMm(e.target.value)} placeholder="MM" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-14 focus:border-black font-poppins" />
                                        <input type="number" name='yy' value={yy} onChange={(e) => setYy(e.target.value)} placeholder="YY" class="text-sm  p-3 bg-[#F2F2F2] border-0 rounded-2xl w-14 focus:border-black font-poppins" />
                                        <input type="number" name='securityCode' value={securityCode} onChange={(e) => setSecurityCode(e.target.value)} placeholder="Security Code" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-32 focus:border-black font-poppins" />

                                    </div>
                                    <div className="grid grid-cols-2 gap-5 mb-4">
                                        <input type="text" name='cardHolderName' value={cardHolderName} onChange={(e) => setCardHolderName(e.target.value)} placeholder="Card Holder Name" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />
                                        <input type="text" name='city' value={city} onChange={(e) => setCity(e.target.value)} placeholder="City" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />

                                        <input type="text" name='billingAddress1' value={billingAddress1} onChange={(e) => setBillingAddress1(e.target.value)} placeholder="Billing Address" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />
                                        <input type="number" name='zipCode' value={zipCode} onChange={(e) => setZipCode(e.target.value)} placeholder="Zip or Postal Code" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />

                                        <input type='text' name='country' value={country} onChange={(e) => setCountry(e.target.value)} placeholder="Country" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />
                                        <input type="number" name='phoneNumber' value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} placeholder="Phone Number" class="text-sm p-3 bg-[#F2F2F2] border-0 rounded-2xl w-72 focus:border-black font-poppins" />
                    ...
                    <div className="lg:w-1/3 p-4 gradient-background rounded-lg lg:ml-4 font-poppins my-auto py-28 px-8">
                        ...
                        <button onClick={handleCheckout} className="bg-black text-white py-4 font-semibold px-6 rounded-2xl mt-4 w-full hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50 transition-all">
                            Subscribe
                        </button>
